...
void VulkanEngine::init()
{
    ...
    create_swapchain_vkb(_windowExtent.width, _windowExtent.height);
...
void VulkanEngine::create_swapchain_vkb(uint32_t width, uint32_t height)
{
...
void VulkanEngine::init_commands()
{
    ...
    for (int i = 0; i < FRAME_OVERLAP; ++i)
    {
        VK_CHECK(vkCreateCommandPool(_device, &cmdPoolCI, nullptr, &_frames[i]._commandPool));
...
void VulkanEngine::init_descriptors()
{
    ...
    uint32_t maxSets = 10;
    globalDescriptorAllocator.init_pool(_device, maxSets, sizes);
